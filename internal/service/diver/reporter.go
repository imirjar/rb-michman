...
type IDiver interface {
	...
	ExecuteDiverReportMap(context.Context, string, string) ([]map[string]interface{}, error)
}
...
func (s Service) GetDiverReportDataMap(ctx context.Context, addr, repID string) ([]map[string]interface{}, error) {
